...
namespace UnityHelper {
    public static class TransformExtensions {
        ...
        /// <summary>
        /// Đặt lại vị trí, tỷ lệ và góc quay của transform trong không gian global, nhưng scale là local
        /// </summary>
        ...
        /// <summary>
        /// Đặt lại vị trí, tỷ lệ và góc quay của transform trong không gian local
        /// </summary>
        /// <param name="transform">Transform để sử dụng</param>
